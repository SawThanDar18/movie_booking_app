    ...
    return ChangeNotifierProvider(
      ...
      child: Scaffold(
            ...
            child: Column(
              ...
              children: [
                Selector<SnacksBloc, List<SnacksVO>?>(
                  ...
                  builder: (BuildContext context, snacks, Widget? child) {
                ...
                Selector<SnacksBloc, List<PaymentVO>?>(
                  ...
                  shouldRebuild: (previous, next) => previous != next,
                  builder:
                      (BuildContext context, paymentMethods, Widget? child) {
                    return Selector<SnacksBloc, int?>(
                      selector: (context, bloc) => bloc.selectPaymentId,
                      shouldRebuild: (previous, next) => previous != next,
                      builder: (BuildContext context, selectPaymentId,
                          Widget? child) {
        ...
        floatingActionButton: Selector<SnacksBloc, double?>(
          ...
          shouldRebuild: (previous, next) => previous != next,
          builder: (BuildContext context, payTotalPrice, Widget? child) {
...
class PaymentMethodView extends StatelessWidget {
  ...
  PaymentMethodView(
      {Key? key, required this.paymentMethods, required this.onTapView})
      : super(key: key);
...
class CardRowView extends StatefulWidget {
  ...
  CardRowView({Key? key, required this.paymentMethod, required this.onTapView})
      : super(key: key);
          ...
          Row(
            children: [
              Icon(
                ...
                color: (widget.paymentMethod?.isSelected == true)
                    ? THEME_COLOR[EnvironmentConfig.CONFIG_THEME_COLOR]
                    : CHECK_OUT_PAGE_LABEL_COLOR,
                size: CARD_ICON_SIZE,
              ),
              SizedBox(
...
class IncreaseAndDecreaseView extends StatefulWidget {
  ...
  @override
  State<IncreaseAndDecreaseView> createState() =>
      _IncreaseAndDecreaseViewState();
}
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            child: Center(
              child: Text(
                ((widget.snack.quantity) == null)
                    ? "0"
                    : widget.snack.quantity.toString(),
                style: TextStyle(
                  color: Colors.grey,
                ),
              ),
