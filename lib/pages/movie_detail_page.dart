...
class MovieDetailsPage extends StatelessWidget {
                              ...
                              Row(
                                children: [
                                  ...
                                  MovieDetailTextView(
                                    ...
                                    color: DETAIL_SUMMARY_TEXT_COLOR,
                                    text:
                                        "Imdb ${movieDetails?.voteAverage.toString()}",
                                  ),
                                ],
                              ),
                              SizedBox(
        ...
        floatingActionButton: Selector<MovieDetailsBloc, MovieVO?>(
          ...
          builder: (context, movieDetails, child) => FloatingButtonView(
            onTapView: () {
              ...
              _navigateToChoosingTimePage(
                  context, movieDetailsBloc.movieDetails);
            },
  ...
  _navigateToChoosingTimePage(BuildContext context, MovieVO? movieDetails) {
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => CinemaDayTimeSlotPage(
                  movieId: movieId,
...
class ActorsSectionView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: (WIDGET_ACTORS[EnvironmentConfig.CONFIG_WIDGET_ACTORS] == true)
            ? ListView(
                scrollDirection: Axis.horizontal,
                padding: EdgeInsets.only(right: MARGIN_MEDIUM_2),
                children: actorsList
                        ?.map(
                          (actor) => CircleShapeHorizontalListView(
                            actorProfilePath:
