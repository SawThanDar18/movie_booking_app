...
import 'package:movie_booking_app/widgets/page_tab_section_view.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                  ...
                  child: (WIDGET_HOME_PAGE_MOVIES[EnvironmentConfig
                                  ...
                                  children: [
                                    ...
                                    SingleChildScrollView(
                                      child: Selector<HomeBloc, List<MovieVO>?>(
                                        selector: (context, bloc) =>
                                            bloc.comingSoonMovies ?? [],
                                        builder: (context, comingSoonMovies,
                                                child) =>
                                            GridView.builder(
                                                shrinkWrap: true,
                                                physics:
...
class DrawerView extends StatelessWidget {
  ...
  DrawerView(
      {required this.name, required this.email, required this.onTapView});
